<template>
  <div>
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
      <div>
        <nav class="flex items-center gap-1.5 mb-3">
          ...
          <span class="text-slate-700 text-sm font-semibold">Mes conférences</span>
        </nav>
        <h1 class="text-3xl font-black tracking-tight">Mes conférences</h1>
        <p class="text-slate-400 text-sm mt-1">Gérez et démarrez vos sessions en direct.</p>
      </div>
      <NuxtLink
    ...
    <div v-else class="flex flex-col items-center justify-center py-24 text-center">
      ...
      <h3 class="font-bold text-slate-700 mb-1">Aucune conférence</h3>
